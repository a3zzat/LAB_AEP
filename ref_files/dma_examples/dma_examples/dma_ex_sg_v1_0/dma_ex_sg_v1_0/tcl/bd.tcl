...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_TTC0_PERIPHERAL_ENABLE {0}  ] $processing_system7_1

  # Create instance: axi_dma_1, and set properties
  set axi_dma_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.0 axi_dma_1 ]
  set_property -dict [ list CONFIG.c_include_sg {1} CONFIG.c_sg_length_width {23} CONFIG.c_sg_include_stscntrl_strm {0} CONFIG.c_m_axi_mm2s_data_width {64} CONFIG.c_include_mm2s_dre {1} CONFIG.c_m_axi_s2mm_data_width {64} CONFIG.c_include_s2mm_dre {1}  ] $axi_dma_1
  ...
  set_property -dict [ list CONFIG.C_RX_FIFO_DEPTH {1024}  ] $axi_fifo_mm_s_1

  # Create instance: axi_interconnect_2, and set properties
  set axi_interconnect_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.0 axi_interconnect_2 ]
  set_property -dict [ list CONFIG.NUM_SI {3} CONFIG.NUM_MI {1}  ] $axi_interconnect_2
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_intf_nets s00_axi_1]
