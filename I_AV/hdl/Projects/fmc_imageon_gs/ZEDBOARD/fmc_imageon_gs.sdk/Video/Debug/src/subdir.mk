...
src/%.o: ../src/%.c
	...
	arm-xilinx-eabi-gcc -Wall -O0 -g3 -IE:/projects/xilinix/master_repo/LAB_AEP/I_R/hdl/Projects/fmc_imageon_gs/ZEDBOARD/fmc_imageon_gs.sdk/fmc_imageon_gs_bsp/ps7_cortexa9_0/include -c -fmessage-length=0 -MT"$@" -I../../fmc_imageon_gs_bsp/ps7_cortexa9_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
